...
class Report extends BaseActiveRecord
{
	...
	public function getInitialData() {
		...
		foreach ($this->items as $item) {
			...
			$object->ranges = array(0);//array((int)$this->default_range);
			$object->measures = array(0);//array((int)$this->default_measure);
			$object->markers = array(0); //array((int)$this->default_marker);
			$objects[] = $object;
		}
